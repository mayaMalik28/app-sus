...
var pinnedNotes = [
    ...
    },
    {
        ...
        info: {
            ...
            todos: null,
            imgUrl: null,
            videoUrl: 'https://www.youtube.com/embed/Nv6vl8E678c',
            todos: null
        }
    },
    {
    ...
    },
    {
        ...
        info: {
            ...
            text: null,
            todos: null,
            imgUrl: "https://www.pitria.com/wp-content/uploads/2017/09/321321.gif",
            videoUrl: null,
            todos: null
        }
    },
...
var notes = [
    ...
    },
    {
        ...
        info: {
            ...
            todos: null,
            imgUrl: null,
            videoUrl: 'https://www.youtube.com/embed/SQbzhYegyNY',
            todos: null
        }
    },
    {
        ...
        info: {
            ...
            text: null,
            todos: null,
            imgUrl: "https://ww2.kqed.org/app/uploads/sites/38/2019/03/tomemeornot3-800x400.jpg",
            videoUrl: null,
            todos: null
        }
    },
...
function saveNote(note) {
    ...
    if (tempNote.isPinned) {
        ...
        gPinnedNotes.splice(idx, 1, tempNote)
        keepStorageService.savePinnedNotesToLocalStorage(gPinnedNotes)
    } else {
        const idx = gNotes.findIndex(note => note.id === tempNote.id);
        if (idx < 0) {
            gNotes.push(tempNote)
        } else {
            gNotes.splice(idx, 1, tempNote)
        }
        keepStorageService.saveNotesToLocalStorage(gNotes)
    }
    console.log(tempNote.type);
